<template>
	<div class="container footer">
		<div type="main" class="active" role="footer-btn">
		...
		<div type="discover" role="footer-btn">
		...
		<div type="order" role="footer-btn">
		...
		<div type="profile" role="footer-btn">
...
<script>
	export default{
		...
		mounted () {
			var me = this;
			$('div[role="footer-btn"]').click(function() {
				if($('.container.footer').find('.active')[0] == this){
					return false;
				}
				$('.container.footer').find('.active').removeClass('active');
				$(this).addClass('active');
				me.$emit($(this).attr('type'));
			})
		},
	}
</script>
